...
class Tournament:
    def __init__(self, players: list[Player], seed=None):
        """
        Initializes the players, teams and games arrays.
        """
    ...
    def play(self, point_limit=1500, round_limit=0, play_endless: bool = False):
        """
        ...
        whole_rounds = True if round_limit > 0 else False
        round_counter = 0
        while not end:
            ...
            round_counter += 1
            if whole_rounds and round_counter == round_limit:
                end = True
